...
public class RobotContainer {
  ...
  private void configureBindings() {
    _calsificationinator.setDefaultCommand(_calsificationinator.zeroMotor());
    ...
    _driverController.y().whileTrue(_calsificationinator.pivotinatorRoutine.quasistatic(Direction.kForward));
    _driverController.b().whileTrue(_calsificationinator.pivotinatorRoutine.quasistatic(Direction.kReverse));
    _driverController.a().whileTrue(_calsificationinator.pivotinatorRoutine.dynamic(Direction.kForward));
    _driverController.x().whileTrue(_calsificationinator.pivotinatorRoutine.dynamic(Direction.kReverse));
