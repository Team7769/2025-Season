...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    new Trigger(_calsificationinator::hasCoralinator).onTrue(_calsificationinator.setWantedState(CalsificationinatorState.IDLE));
    new Trigger(_calsificationinator::hasCoralinator).onFalse(_calsificationinator.setWantedState(CalsificationinatorState.PICKUP));
  ...
  public ParallelCommandGroup reefSetinator(double position, int side, CalsificationinatorState calsificationinatorState, ClawState clawState, ScoringTarget scoringTarget) {
    return new ParallelCommandGroup(new InstantCommand(()-> {
      ...
      SmartDashboard.putNumber("targetPosition", _elevatinatorTarget);
