...
public final class Constants {
  ...
  public static class FieldConstants {
    ...
    public static final Pose2d kBlueSourceTop = new Pose2d(1, 7, new Rotation2d(124));
    public static final Pose2d kBlueSourceLow = new Pose2d(1, .9, new Rotation2d(230));

    public static final Pose2d kRedSourceTop = new Pose2d(GeometryUtil.mirrorTranslationForRedAlliance(kBlueSourceTop.getTranslation()), new Rotation2d(230));
    public static final Pose2d kRedSourceLow = new Pose2d(GeometryUtil.mirrorTranslationForRedAlliance(kBlueSourceLow.getTranslation()), new Rotation2d(124));
