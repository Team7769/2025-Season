...
public class Claw extends StateBasedSubsystem<ClawState>
{
    ...
    public Claw()
    {
        ...
        _pivotinator = new TalonFX(Constants.SubsystemConstants.kClawPivotinatorID);
        ...
        _pivotMotionMagic.withMotionMagicCruiseVelocity(RotationsPerSecond.of(5)) // 5 (mechanism) rotations per second cruise
        ...
        _topRollinator = new TalonFX(Constants.SubsystemConstants.kClawTopRollinatorID);

        _bottomRollinator = new TalonFX(Constants.SubsystemConstants.kClawBottomRollinatorID);
        
        //bottom Rollinator will follow the top Rollinator in the opposite direction
        _bottomRollinator.setControl(new Follower(20, true));
        /// //#endregion
        /// //#region Detectinator config
        
        _algaeDetectinator = new DigitalInput(Constants.SubsystemConstants.kClawAlgaeDetectinatorChannel);
        _algaeDebouncinator = new Debouncer(Constants.SubsystemConstants.kClawAlgaeDebounceTime, DebounceType.kFalling);
        /// //#endregion
    ...
    public void handleCurrentState()
    {
        switch (_currentState) {
            case IDLE:
                //TODO: figure out how feed forward works
                ...
                break;
            case FLOOR_INTAKE:
                _pivotinator.setPosition(Rotation.of(0.375));
                _topRollinator.set(.5);
                break;
            case DEALGIFY:
                _pivotinator.setPosition(Rotation.of(0.25));
                _topRollinator.set(.5);
                break;
            case PREP_NET:
                _pivotinator.setPosition(Rotation.of(0.125));
                break;
            case PREP_PROCESSOR:
                _pivotinator.setPosition(Rotation.of(0.25));
                break;
